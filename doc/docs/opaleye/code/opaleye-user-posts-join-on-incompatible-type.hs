...
type UserPGW = UserPoly (Column UserId) (Column PGText) (Column PGText)
type UserPGR = UserPoly (Column UserId) (Column PGText) (Column PGText)
...
type PostPGW = PostPoly (Column PostId) (Column PGText) (Column UserId)
type PostPGR = PostPoly (Column PostId) (Column PGText) (Column UserId)
